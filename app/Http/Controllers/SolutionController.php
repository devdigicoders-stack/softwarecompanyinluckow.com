    ...
    private function getSolutionMapBySlug(string $slug): array
    {
        $solutionsMap = [
            ...
            'hrms-software-in-lucknow' => [
                'title' => 'HRMS Software in Lucknow | Best Payroll & HR Management System',
            ...
            'hospital-management-software-in-lucknow' => [
                'title' => 'Hospital Management Software in Lucknow | Best HMS & Clinic ERP',
            ...
            'mlm-software-in-lucknow' => [
                'title' => 'MLM Software in Lucknow | Binary, Matrix & Generation Network System',
                'h1' => 'MLM Software & Network Marketing System Guide in Lucknow',
                'icon' => 'bi-diagram-2',
                'meta_description' => 'Guide to MLM software in Lucknow. Discover custom binary, matrix, and generation network marketing software with real-time commissions and e-wallet payout engines.',
                'excerpt' => 'Custom MLM software automates network marketing genealogy trees, binary/matrix payout calculations, direct referral bonuses, e-wallet transactions, and member portals.',
                'features' => [
                    'Binary, Matrix, Single-Leg & Generation Plan Calculators',
                    'Real-Time Genealogy Tree & Downline Member Visualizer',
                    'Automated E-Wallet, Payout Processing & TDS Deductions',
                    'Member Self-Service Portal & Android Mobile App Sync',
                ],
                'target_audience' => ['Direct Selling Companies', 'MLM Businesses', 'Network Marketing Agencies', 'Product Distribution Networks'],
                'benefits' => [
                    'Automate complex commission calculations with zero calculation errors.',
                    'Provide members with real-time downline genealogy tracking.',
                    'Ensure full statutory compliance with TDS tax calculation.',
                ],
                'faqs' => [
                    ['question' => 'What MLM plan structures are supported in custom MLM software?', 'answer' => 'Custom MLM software supports Binary, Matrix, Unilevel, Generation, Board, Gift/Helping, and Hybrid Network Marketing plan structures.'],
                    ['question' => 'Does MLM software support real-time downline genealogy tree visualization?', 'answer' => 'Yes. Members and admins can view real-time graphical genealogy trees showing leg volume, active members, and commission qualification status.'],
                    ['question' => 'How are payouts and e-wallet withdrawals managed?', 'answer' => 'Members can request withdrawals from their e-wallet, which auto-calculates admin charges, TDS deductions, and exports bank transfer payout sheets.'],
                    ['question' => 'How much does custom MLM software cost in Lucknow?', 'answer' => 'Custom MLM software pricing ranges from ₹50,000 for standard binary/matrix plans to ₹2,00,000+ for enterprise multi-product MLM portals with mobile apps.'],
                    ['question' => 'Can members track their earnings on mobile apps?', 'answer' => 'Yes. Custom Flutter mobile apps allow downline members to check wallet balances, view genealogy trees, register new members, and request payouts.'],
                    ['question' => 'Is data security maintained for member wallet transactions?', 'answer' => 'Yes. Financial transactions use encrypted database fields, 2FA OTP verification, transaction PINs, and detailed audit log tracking.'],
                    ['question' => 'Can MLM software integrate with e-commerce product catalogs?', 'answer' => 'Yes. Members can purchase repurchase products online, automatically generating BV/PV points credited to their downline trees.'],
                    ['question' => 'How long does custom MLM software development take?', 'answer' => 'Development typically takes 3 to 6 weeks, spanning plan logic verification, tree UI prototyping, e-wallet setup, and UAT testing.'],
                    ['question' => 'Do clients receive full source code ownership?', 'answer' => 'Yes. Software Company in Lucknow provides 100% full source code ownership and database schemas upon delivery.'],
                    ['question' => 'How do I request an MLM software demo in Lucknow?', 'answer' => 'Contact Software Company in Lucknow in Aliganj to test a live demonstration of admin and member MLM dashboards.'],
                ],
            ],
            'restaurant-management-software-in-lucknow' => [
                'title' => 'Restaurant Management Software in Lucknow | POS & Billing System',
                'h1' => 'Restaurant Management Software & POS Guide in Lucknow',
                'icon' => 'bi-receipt-cutoff',
                'meta_description' => 'Restaurant management software and POS guide in Lucknow. Discover Kitchen Order Ticket (KOT) automation, table management, inventory stock, and thermal billing.',
                'excerpt' => 'Restaurant POS software digitizes dining operations, managing table reservations, Kitchen Order Tickets (KOT), inventory stock, GST billing, and QR menu ordering.',
                'features' => [
                    'Touchscreen POS Counter & Thermal Bill Printing',
                    'Kitchen Order Ticket (KOT) Automation & Kitchen Display Screens',
                    'Table Management, Split Billing & Captain Mobile Apps',
                    'Recipe Inventory Management & Daily Consumption Reports',
                ],
                'target_audience' => ['Fine-Dine Restaurants', 'Cafes & Bars', 'Fast Food Outlets', 'Cloud Kitchens'],
                'benefits' => [
                    'Accelerate table turnaround and kitchen order dispatch times.',
                    'Eliminate order mistakes between waiters and kitchen staff.',
                    'Prevent raw material ingredient theft with recipe stock deduction.',
                ],
                'faqs' => [
                    ['question' => 'What is Restaurant POS and KOT Management Software?', 'answer' => 'Restaurant POS software handles table billing, Kitchen Order Ticket (KOT) thermal printing, menu management, inventory stock tracking, and sales analytics.'],
                    ['question' => 'Can waiters take orders on Android tablets or mobile phones?', 'answer' => 'Yes. Waiters use Captain Order Apps on tablets/phones to take orders at tables, sending KOTs directly to kitchen printers.'],
                    ['question' => 'How does recipe inventory management prevent stock theft?', 'answer' => 'Every dish sold automatically deducts exact ingredient quantities (e.g. flour, cheese, meat) from inventory stock based on pre-set recipes.'],
                    ['question' => 'How much does restaurant management software cost in Lucknow?', 'answer' => 'Single-counter restaurant billing software starts around ₹25,000, while complete multi-counter POS systems with KOT integration range from ₹45,000 to ₹1,20,000.'],
                    ['question' => 'Does the software support QR code digital menus for customer tables?', 'answer' => 'Yes. Customers scan QR codes on tables to view digital menus and place direct orders to the kitchen POS.'],
                    ['question' => 'Can restaurant software handle GST tax calculations and daily sales reports?', 'answer' => 'Yes. The software calculates CGST/SGST rates, handles item discounts, and generates daily sales summary reports.'],
                    ['question' => 'Does the software operate offline if internet drops?', 'answer' => 'Yes. Local counter POS billing continues uninterrupted during internet outages and syncs with cloud analytics when reconnected.'],
                    ['question' => 'How long does restaurant POS deployment take?', 'answer' => 'Deployment and staff training take 2 to 4 days, including menu item and price catalog setup.'],
                    ['question' => 'Is source code ownership included?', 'answer' => 'Yes. Software Company in Lucknow provides 100% full source code ownership upon project completion.'],
                    ['question' => 'How do I purchase restaurant POS software in Lucknow?', 'answer' => 'Schedule a live demo with Software Company in Lucknow in Aliganj to test hardware compatibility and POS workflows.'],
                ],
            ],
